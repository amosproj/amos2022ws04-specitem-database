...
public class TaggingRaceConditionsTest {
    ...
    void testTagsAdditionNoConcurrency() throws IOException {
        ...
        this.specItemService.saveTags(specItem, Collections.singletonList(newTagsUser1));
        this.specItemService.saveTags(specItem, Collections.singletonList(newTagsUser2));
    ...
    private SpecItem createSpecItemWithTag() throws IOException {
        ...
        this.specItemService.saveTags(specItemNoTags, List.of(originalTag));
